...
public class BasicCollectionReader extends JCasCollectionReader_ImplBase {

	Logger logger = UIMAFramework.getLogger(BasicCollectionReader.class);
	...
	public void getNext(JCas jcas) throws IOException, CollectionException {
		...
		jcas.setDocumentText(FileUtils.readFileToString(f));
